...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Start->Size = System::Drawing::Size(1210, 38);
			...
			this->move->Size = System::Drawing::Size(1210, 10);
			...
			this->Random->Size = System::Drawing::Size(1211, 38);
			...
			this->Chat->Size = System::Drawing::Size(152, 379);
			this->Chat->TabIndex = 17;
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(1100, 470);
			...
			// Message
			// 
			this->Message->Location = System::Drawing::Point(1068, 495);
			this->Message->Name = L"Message";
			this->Message->Size = System::Drawing::Size(152, 20);
			this->Message->TabIndex = 15;
			// 
			// sends
			// 
			this->sends->FlatStyle = System::Windows::Forms::FlatStyle::Flat;
			this->sends->Location = System::Drawing::Point(1068, 545);
			this->sends->Name = L"sends";
			this->sends->Size = System::Drawing::Size(152, 49);
			...
			this->ClientSize = System::Drawing::Size(1232, 645);
...
#pragma endregion
	private: System::Void Start_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		//1051; 53
		this->move->Size = System::Drawing::Size(1210, 53);
		...
		flag = true;
		   ...
		   void Displayingamessage(char* msg) {
			   System::String^ text = "";
			   for (int i = 7; (gcnew String(msg))[i] != '^'; i++)
			   {
				   text += (gcnew String(msg))[i];
			   }
